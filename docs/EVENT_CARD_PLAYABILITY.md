...
event_cardは `docs/STORY_FUNCTION_FRAMEWORK.md` の Scene Function Check に照らして、`scene_start_state`、`scene_goal`、`obstacle`、`emotional_change`、`scene_end_state`、`next_hook` のいずれかに接続できること。
