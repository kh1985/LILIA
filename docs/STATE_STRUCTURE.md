...
`profile.md` の Initial Scene Anchors / context / unspoken / everyday anchors は、初回scene前に `current/scene.md`、`current/event_card.md`、`current/story_spine.md`、`current/knowledge_state.md`、`story/story_deck.md`、`story/relationship_spine.md`、`current/hotset.md` へ分解して初期反映する。
...
`first_scene_pending` / `first_scene_ready` の場合は `lilia/main/profile.md` も必読にし、profileから初期反映された `current/scene.md`、`current/event_card.md`、`current/story_spine.md`、`current/knowledge_state.md`、`story/story_deck.md`、`story/relationship_spine.md`、`current/hotset.md` も読む。
