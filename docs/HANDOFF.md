...
combat / villain / visual / manga / AI Harness は、長期ROADMAP上の参照候補であり、初期MVP、New Session Initialization、Event Card Playability Gate、Story / Relationship Accumulation Loopには採用しない。
...
- ROADMAP上の直前項目は Story / Relationship Accumulation Loop。現状はdocs正本化とテンプレート最小接続が完了済み。launcher / CLI、自動プレイ検証、AI Harnessは後続。
