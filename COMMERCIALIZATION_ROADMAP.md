...
- **3 本フック運用（戦闘なし版、P-D）**: β前P0へ格上げ済み。詳細は `## 12. Three Hook Spine MVP` と `RELEASE_WBS.md` の `HOOK-001〜HOOK-006` を正本にする。
...
### 13.1 Why Complete Blocking Is Not Expected
...
### 13.2 Initial Beta Required Controls
...
### 13.3 Session Authorization And Storage
...
### 13.5 Structured Output / Server-side Control
...
### 13.9 Claude Code Reference Policy
...
### 13.10 External Security References
