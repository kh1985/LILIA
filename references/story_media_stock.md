...
- 新しい event_card を作る時だけ、Q&A、現在scene、関係温度に合うものを 1-3 個だけ選び、感情の骨として短く変換する。
- 50作品を毎回プロンプトへ読み込まない。トークン効率のため、このファイルは研究棚として扱う。
- ユーザーが作品名を明示した時だけ、その作品を `user hint` として扱う。

## Selection Criteria

- LILIA の関係育成型AI恋愛シミュレーションとして、恋愛・生活・事件へ変換しやすい。
...
作品番号は source hint であり、LILIA の正本設定ではない。

- romance / sweetness: 28, 29, 37, 38, 39, 40, 41, 42, 43, 44, 45, 50
- daily / life: 12, 27, 28, 30, 34, 37, 40, 49
...
- memory / promise + place: 3, 12, 13, 14, 30, 40, 41, 43
- self-recognition: 4, 13, 19, 21, 27, 30, 37, 39, 45, 46
- secret / unsent: 5, 6, 9, 16, 23, 31, 35, 36, 49
- character density: 5, 8, 11, 20, 31, 33, 35, 44

## Quick Selection Guide

- institution / record（行政・病院・会社・制度の奥へ潜る）: 1, 2, 16, 31, 34, 36, 46
- memory / promise + place（古い因縁や土地が効く）: 3, 12, 13, 14, 30, 40, 41, 43
- ability / rule（能力ルールと機転が欲しい）: 6, 7, 8, 21, 22, 47, 48
- organization / ideology（組織の大義と個人感情）: 1, 15, 16, 19, 31, 35, 46
- romance / sweetness（甘美なロマンス、視線、沈黙、余韻）: 28, 29, 37, 38, 39, 40, 41, 42, 43, 44, 45
- boundary / intimacy（ヒロイン/関係性を濃くしたい）: 9, 20, 27, 28, 29, 33, 37, 39, 44, 45, 50
- daily / life（生活感と拠点を濃くしたい）: 12, 27, 28, 30, 34, 40, 49
- character density（敵/関係者を濃い人物で出したい）: 5, 8, 11, 20, 31, 35, 44
- secret / unsent（言えなかったこと、未送信、隠した不安）: 23, 33, 37, 39, 40, 45
- self-recognition（自己認識、自己受容、弱さの見直し）: 4, 21, 26, 27, 30, 45, 47
