...
11. `lilia/main/profile.md` の必要箇所
12. `lilia/main/voice.md`
13. `lilia/main/state.md`
14. `lilia/main/relationship.md`
15. `lilia/main/memory.md`
16. `lilia/main/beliefs.md` の必要箇所
17. `story/relationship_spine.md`
18. `story/story_deck.md` の必要箇所
