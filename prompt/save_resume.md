...
11. `lilia/main/core.md`
12. `lilia/main/profile.md` の必要箇所
13. `lilia/main/voice.md`
14. `lilia/main/state.md`
15. `lilia/main/relationship.md`
16. `lilia/main/memory.md`
17. `lilia/main/beliefs.md` の必要箇所
18. `story/relationship_spine.md`
19. `story/story_deck.md` の必要箇所
