...
7. `lilia/main/core.md`
8. `lilia/main/voice.md`
9. `lilia/main/state.md`
10. `lilia/main/relationship.md`
11. `lilia/main/memory.md`
12. `lilia/main/beliefs.md`
13. `story/relationship_spine.md`
14. `story/story_deck.md`
...
4. 選んだengineの構造から、感情の骨を1行で抽出する。
   - 必要なら `references/story_media_stock.md` の Quick Selection Guide から候補作品を3-5個に絞り、その中から1-3個だけ採用する。
   - 50作品全部を読まない。Quick Selection Guide と Selection Signals だけで候補を絞る。
   - 採用した作品から抜くのは、感情の骨、抽象構造、選択の力学だけである。本文、台詞、人物配置、固有名詞、展開順は使わない。
   - 参考作品名を作中本文に出さない。
