...
9. `profile.md` の `Initial Scene Anchors` / `context` / `unspoken` / `everyday anchors` から、`current/scene.md`、`current/event_card.md`、`story/story_deck.md`、`story/relationship_spine.md`、`current/hotset.md` を初期化する。
...
- Q3 体験の味 → story_deck.md / relationship_spine.md / event_card.md / style/reference.md / style/rules.md
...
- GM生成の初回event → `current/event_card.md` / `story/story_deck.md` / `current/scene.md` / `story/relationship_spine.md`
