...
例:
- 「外では物腰柔らかいけど、一人だと冷たい目をする」
- 「人前では明るく振る舞うけど、夜は静かに泣いている」
- 「常に礼儀正しい、けど誰のことも信じていない」
...
1. Main Question
   ...
   - 「自分で決める余地を残すことを守ったまま、ユーザーとの距離を選び直せるか」のような汎用テンプレを名前だけ変えて使わない。

2. Background Truth
   - Q5 の回答を必ず骨格に含める。
   - 「事情を聞かれても、すぐ整理して話せる状態ではない」のような汎用文言で Q5 を置き換えない。
...
4. Drift Guard
   ...
   - 「ビニール傘」のような汎用具体物を残さない（Q3 と無関係なら削除）。
